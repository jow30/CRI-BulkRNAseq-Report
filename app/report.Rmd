...
if (length(params$comp_pair) > 0) {
  ...
  if(params$gsea_msigdb){
    ...
    for (comp in gsea_plots) {
      ...
      cat(paste0('![](', params$report_out_dir, '/4.Functional_analysis/GSEA_plot_', comp, '.png)'))
      cat(paste0('![](', params$report_out_dir, '/4.Functional_analysis/GSEA_bubble_plot_', comp, '.png)'))
      cat('</div>')
    }
  }
}
